...
var factorial = function(n) {
	//base case is n === 1
	//decrement n and cal factorial recursively
	if (n === 0) {
		return 1;
	}
	if(n < 0){
...
var arraySum = function(array) {
  ...
  var isArray = Array.isArray(array[0]);
  while(isArray){
  	array = [].concat(array[0], array.slice(1));
  	isArray = Array.isArray(array[0]);
  }
...
var exponent = function(base, exp) {
	...
	if(exp < 0){
    return parseInt(((1/base) * exponent(base, exp+1)).toFixed(4));
	}
...
var rMap = function(array, callback) {
	...
	return [callback(array[0])].concat(newArr, callback);
};
...
var capitalizeWords = function(array) {
	...
	return [array[0].toUpperCase()].concat(array.slice(1));
};
...
var capitalizeFirst = function(array) {
	...
	return [array[0][0].toUpperCase() + array[0].slice(1)].concat(array.slice(1));
};
...
var letterTally = function(str, obj) {
	...
	if(obj.hasOwnProperty(string[0])){
    obj[string[0]]++;
	} else {
		obj[string[0]] = 0;
	}
